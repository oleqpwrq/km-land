  ...
  return (
    <a
      ...
      className={cx(
        ...
        "border border-white/20 shadow hover:bg-white/10",
        "no-underline leading-none align-middle whitespace-nowrap shrink-0",
        className
      )}
    >
      Позвонить
    ...
    <div className="min-h-screen">
      <header className="sticky top-0 z-40 w-full border-b border-white/10 bg-[#0e1114]/70 backdrop-blur">
        <div className="mx-auto max-w-7xl px-5 sm:px-6 md:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <a href="#form" className="rounded-xl px-4 py-2 text-sm font-semibold shadow whitespace-nowrap no-underline" style={{ background: accent }}>
              Оставить заявку
            </a>
            <CallButton />
          </div>
      ...
      {/* ===== Footer (одна линия на мобиле) ===== */}
      <footer className="border-t border-white/10">
        {/* всегда 3 колонки, чтобы всё было в одну линию даже на мобиле */}
        <div className="mx-auto max-w-7xl px-5 sm:px-6 md:px-8 py-10 text-sm text-white/60 grid grid-cols-3 gap-3 items-center">
          {/* Лого/название */}
          <div className="flex items-center gap-3 min-w-0">
            <Image src="/logo.png" alt="KMLeads" width={24} height={24} className="rounded shrink-0" />
            <div className="truncate">
              <div className="font-semibold text-white truncate">KMLeads</div>
              <div className="truncate">Корпоративный Маркетинг</div>
            </div>
          </div>

          {/* Адрес + Позвонить — в одну строку без переноса */}
          <div className="flex items-center justify-center gap-3 min-w-0 flex-nowrap">
            <span className="truncate">Москва, Проспект Мира 102к1, БЦ «Парк Мира»</span>
            <CallButton className="px-4 py-2 text-sm" />
          </div>

          {/* Telegram справа, тоже в одну строку */}
          <div className="flex items-center gap-3 justify-end">
            <a href="https://t.me/kmleads" target="_blank" rel="noopener noreferrer"
               className="inline-flex items-center gap-2 rounded-xl border border-white/10 px-3 py-2 hover:bg-white/10 whitespace-nowrap no-underline leading-none">
